    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Chat with you <span className="text-green-600">document</span> in seconds
        </h1>

        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill allows you to have conversation with any PDF document. Simply upload your file and start askin questions right away.
        </p>
              ...
              <div className='mt-16 flow-root sm:mt-24'>
                <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <Image
                    ...
                    className="rounded-md bg-white p-2 sm:p- md:p-20 shadow-2xl ring-1 ring-gray-900/10"
                    width={1364} 
                    height={866}
                    alt="product preview"
                    quality={100}
